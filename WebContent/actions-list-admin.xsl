	...
	<xsl:template match="/">
		<html lang="en">
			<head>
				...
				<title>Client web service : Liste des actions</title>
			</head>
			<body>
				...
				<div class="container">
					<h1 class="display-4 text-center">
						<i class="fas fa-exchange-alt"></i>
						Administration des actions
						<a href="/Currency-client/dashboard?addAction">
						...
						<thead class="thead-light">
							...
							<xsl:for-each
								...
								<tr class="text-center">
									...
									<td>
										<a href="/Currency-client/dashboard?updateAction={@ns2:id}">
											<button class="btn btn-primary btn-sm">
									...
									<td>
										<button class="btn btn-danger btn-sm"
											data-toggle="modal" data-target="#delete-action{@ns2:id}">
											<i class="fas fa-trash-alt"></i>
											Supprimer
										</button>

										<!-- Delete confirmation modal -->
										<div class="modal fade" id="delete-action{@ns2:id}"
											...
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body alert alert-warning">
														<p class="h2">
															Êtes-vous sûre de supprimer l'action numero
															<xsl:value-of select="@ns2:id" />
															?
														</p>
													</div>
