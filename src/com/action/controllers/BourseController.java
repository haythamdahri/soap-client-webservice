...
public class BourseController extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if( id == null ) {
				String renderedHtml = MainUtils.getRenderedBourses();
				...
				if( type != null && type.equalsIgnoreCase("list") ) {
					String renderedHtml = MainUtils.getRenderedBourses(Long.parseLong(id));
					Writer writer = response.getWriter();
					...
					String renderedHtml = MainUtils.getRenderedBourse(Long.parseLong(id));
					Writer writer = response.getWriter();
